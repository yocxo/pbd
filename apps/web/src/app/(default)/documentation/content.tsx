  ...
  return (
    <div className="md:grow">
      <div className="text-lg text-gray-600">
        <h2 className="h2 mb-4 text-gray-900">Introduction to Simple</h2>
        <p className="mb-8">
        ...
        <h3
          id="installation"
          className="h3 mb-4 text-gray-900"
        ...
        <p className="mb-8 flex items-center rounded border border-blue-200 bg-blue-100 px-3 py-4 text-base text-gray-800">
          <svg
            className="mr-2 h-4 w-4 shrink-0 fill-current text-blue-500"
        ...
        <h3
          id="quick"
          className="h3 mb-8 text-gray-900"
          style={{ scrollMarginTop: '100px' }}
        >
          Quick start
        </h3>
        <h4 className="h4 mb-4 text-gray-900">Customising settings</h4>
        <p className="mb-8">
      ...
      <div className="mt-8">
        ...
        <a
          className="mb-4 flex items-center justify-between rounded border border-gray-200 bg-white p-4 shadow-md transition duration-300 ease-in-out hover:shadow-lg"
          href="#0"
        >
          <div>
            <div className="text-normal mb-1 font-medium">
              Folder components
            </div>
          ...
          <svg
            className="ml-6 h-4 w-4 shrink-0 fill-current text-blue-600"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          <div>
            <div className="text-normal mb-1 font-medium">Deploy hooks</div>
            <div className="text-sm text-gray-600">
      ...
      <div className="pt-6">
        <div className="flex flex-col text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <div className="mb-4 font-medium md:mb-0">Was this page helpful?</div>
          <ul className="-m-2 inline-flex justify-center">
            <li className="p-2">
        ...
        <hr className="mt-6 h-px w-full border-0 bg-gray-200 pt-px" />
      </div>
    </div>
  );
}
