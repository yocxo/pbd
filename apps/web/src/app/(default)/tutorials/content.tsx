      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="mb-12 border-b border-gray-300 pb-4">
            <ul className="-mx-5 -my-1 flex flex-wrap justify-center font-medium md:justify-start">
                ...
                <header>
                  ...
                  <div className="mb-3">
                    <ul className="-m-1 flex flex-wrap text-xs font-medium">
                      ...
                      <li className="m-1">
                        <span className="inline-flex rounded-full bg-white px-3 py-1 text-center text-gray-800 shadow-sm">
                          4 min read
                        </span>
                      </li>
                    </ul>
