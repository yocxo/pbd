        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="overflow-x-auto">
            <table className="w-full table-auto border-b border-gray-200">
              {/* Table header */}
              <thead>
                <tr className="border-t border-gray-200 text-base sm:text-lg">
                  <th className="text-bold min-w-48 py-4 pr-2 text-left">
                    Breakdown of features
                  </th>
                  <th className="text-bold px-2 py-4 text-center">Starter</th>
                  <th className="text-bold px-2 py-4 text-center">Premium</th>
                  <th className="text-bold px-2 py-4 text-center">Agency</th>
                  <th className="text-bold py-4 pl-2 text-center">
                    Enterprise
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 py-4 text-center text-sm font-medium">
                    <svg
                      className="inline-flex h-3 w-3 fill-current text-green-500"
                      viewBox="0 0 12 12"
                  ...
                  <td className="py-4 pl-2 text-center text-sm font-medium">
                    <svg
                      className="inline-flex h-3 w-3 fill-current text-green-500"
                      viewBox="0 0 12 12"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 py-4 text-center text-sm font-medium">
                    <svg
                      className="inline-flex h-3 w-3 fill-current text-gray-400 opacity-75"
                      viewBox="0 0 12 12"
                      xmlns="http://www.w3.org/2000/svg"
                    >
